...
;;; [x] I completed this assignment with assistance from Joey (pointed out that constants in the if-blocks don't need parens)
;;;     and/or using these external resources: none other
